...
public class ScoreBoardDialogScoreBoardDialog implements Serializable {

    private final AlertDialog.Builder builder;
    private AlertDialog dialog;
    private View view;

    public ScoreBoardDialogScoreBoardDialog(final OptionsDialogIntf classCallBack, int yellowWins, int redWins){
